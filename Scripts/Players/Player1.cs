...
public class Player1 : MonoBehaviour
{
    ...
    private void Awake()
    {
        gameInput.OnPlayer1Jump += GameInput_OnPlayer1Jump;
    }

    private void Update()
    {
        inputVector = gameInput.GetMovement1VectorNormalized();

        var effects = GetComponent<Player1Effects>();
        if (effects != null)
    ...
    private void GameInput_OnPlayer1Jump(object sender, System.EventArgs e)
    {
    ...
    public void SetJumpSpeed1(float jumpSpeed)
    {
        this.jumpSpeed = jumpSpeed;
    }

    public void SetMoveSpeed1(float moveSpeed)
    {
